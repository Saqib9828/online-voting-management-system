<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="agminlog.aspx.cs" Inherits="OVMS.admin.agminlog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="accountInfo" align="left">
              <fieldset class="login" style="color: #000000">
                    ...
                    <p style="font-weight: bold; font-size: large; color: #000000;">Admin_ID:</p>
                    &nbsp;&nbsp;
