...
{
    public partial class chang_pass : System.Web.UI.Page
    {
...
Connect Timeout=30;User Instance=True");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            sqlcon.Open();
            string name = ("select name from voter_data where en_no='" + TextBox1.Text + "'");
            ...
            string password = ("select password from voter_data  where en_no='" + TextBox1.Text + "'");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox3.Text == TextBox7.Text)
            {
                ...
                {
                    SqlCommand sqlcmd = new SqlCommand("Update voter_data set password='" + TextBox6.Text + "' where en_no='" + TextBox1.Text + "'", sqlcon);
                    sqlcon.Open();
